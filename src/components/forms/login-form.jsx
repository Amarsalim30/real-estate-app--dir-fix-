    ...
    <div className="space-y-4">
      <div>
        ...
        <input
          {...register("identifier")}
          type="text"
          className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 ${errors.identifier ? "border-red-500" : "border-gray-200"} text-gray-900 bg-white placeholder-gray-400`}
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            {...register("password")}
            className={`w-full px-4 py-3 pr-12 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200 ${errors.password ? "border-red-500" : "border-gray-200"

...
const handlePrint = (transactions) => {
  const doc = new jsPDF();
...
const handleExport = () => {
  ...
  // 🔒 Hide print-sensitive elements manually
  const elementsToHide = element.querySelectorAll('.print-hidden-fix');
  elementsToHide.forEach(el => el.style.display = 'none');

  const opt = {
    margin: 0.5,
    filename: `buyer-statement-${new Date().toLocaleDateString()}.pdf`,
  ...
  return (
    <DashboardLayout>
      ...
      <div ref={exportRef}>
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            <Link
              ...
              className="p-2 text-gray-400 hover:text-gray-600 rounded-full hover:bg-gray-100 transition-colors print-hidden-fix "
            >
        ...
        {/* Summary Cards */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 print-hidden-fix">
        ...
        {/* Filters */}
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-8 print-hidden-fix">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select
                ...
                className="text-gray-600 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
              >
